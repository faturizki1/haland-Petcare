...
export default function CreateRawatInapPage() {
  ...
  async function onSubmit(values: InpatientInput) {
    ...
    toast({ title: "Pasien rawat inap berhasil ditambahkan" })
    router.push("/owner/rawat-inap")
    router.refresh()
  }
  ...
  return (
    <div className="mx-auto max-w-lg space-y-6">
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="cage_number">Nomor Kandang</Label>
          <Input
            id="cage_number"
            placeholder="Contoh: A-01 (opsional)"
            {...form.register("cage_number")}
          />
        </div>
        <div className="space-y-2">
          ...
          <Textarea
            id="notes"
            placeholder="Catatan awal (opsional)"
            {...form.register("notes")}
          />
        </div>
