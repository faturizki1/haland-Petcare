...
import { Calendar, BedDouble, ShoppingCart, DollarSign } from "lucide-react"
...
export default async function StaffDashboardPage() {
  ...
  const todayTxCount = transactions?.length || 0

  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-display font-bold">Dashboard Staff</h1>
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Link href="/staff/pos">
          <Card className="hover:shadow-md transition-shadow cursor-pointer">
            ...
            <CardContent>
              <div className="text-2xl font-bold">{todayTxCount}</div>
            </CardContent>
          </Card>
        </Link>
        <Link href="/staff/pos">
